...
export default class ImageUpload extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      confidence: null, // Add confidence property
      predicted_class: null, // Add confidence property
    };
  }
    ...
    .then((response) => {
        ...
        if (response.status === 201) {
          this.setState({
            ...
            confidence: response.data.confidence, // Set confidence in state
    ...
    return (
      <div className="container py-5">
              ...
              <div className="card shadow">
                ...
                <div className="card-header">
                  <h4 className="card-title fw-bold">
                    Detect Images among DOG|CATS|CARS|BIKES
                  </h4>
                </div>
        ...
        <div className="accuracy">
            <br></br>
            <h6>The Accuracy is: {this.state.confidence !== null ? `${this.state.confidence}%` : "Calculating..."}</h6>
            <h6>The Predicted Image belongs to: {this.state.predicted_class !== null ? `${this.state.predicted_class}` : "Detecting"}</h6>
        </div>
      </div>
    );
  }
